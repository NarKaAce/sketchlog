...
class SketchList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'Sketch';
    private static $primaryKey = 'id';
    private static $formName = 'form_SketchList';
    private $limit = 20;
    ...
    public function __construct($param = null)
    {
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['SketchForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $column_Sketch = new TDataGridColumn('imagem', "Imagem", 'left');
        ...
        $this->datagrid->addColumn($column_Sketch);

        $action_onEdit = new TDataGridAction(array('SketchForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('SketchList', 'onDelete'));
