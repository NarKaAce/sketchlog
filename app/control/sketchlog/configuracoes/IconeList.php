...
class IconeList extends TPage
{
    ...
    private static $activeRecord = 'Icone';
    private static $primaryKey = 'id';
    private static $formName = 'form_IconeList';
    private $limit = 20;
    ...
    public function __construct($param = null)
    {
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['IconeForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $column_icone = new TDataGridColumn('imagem', "Imagem", 'left');
        ...
        $action_onEdit = new TDataGridAction(array('IconeForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('IconeList', 'onDelete'));
