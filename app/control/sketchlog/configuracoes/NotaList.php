...
class NotaList extends TPage
{
    ...
    private static $formName = 'form_NotaList';
    private $limit = 20;
    ...
    public function __construct($param = null)
    {
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['NotaForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('NotaForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('NotaList', 'onDelete'));
