...
class ConsoleList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'Console';
    private static $primaryKey = 'id';
    private static $formName = 'form_ConsoleList';
    private $limit = 20;
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Console");
        $this->limit = 20;
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['ConsoleForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('ConsoleForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('ConsoleList', 'onDelete'));
