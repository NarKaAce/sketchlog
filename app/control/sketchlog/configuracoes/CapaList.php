...
class CapaList extends TPage
{
    ...
    private static $activeRecord = 'Capa';
    private static $primaryKey = 'id';
    private static $formName = 'form_CapaList';
    private $limit = 20;
    ...
    public function __construct($param = null)
    {
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['CapaForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('CapaForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('CapaList', 'onDelete'));
        ...
        try
        {
            ...
            if ($objects)
            {
                ...
                foreach ($objects as $object)
                {
                    ...
                    $row->popover = 'true';
                    $row->popside = 'top';
                    $row->popcontent = "<img src='$object->imagem' style='max-width:200px;'>";
