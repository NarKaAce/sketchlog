...
class DificuldadeList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'Dificuldade';
    private static $primaryKey = 'id';
    private static $formName = 'form_DificuldadeList';
    private $limit = 20;
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Dificuldade");
        $this->limit = 20;
        ...
        $row1 = $this->form->addFields([new TLabel("Valor:", null, '14px', null, '100%'), $valor], [new TLabel("Descrição:", null, '14px', null, '100%'), $descricao]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['DificuldadeForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('DificuldadeForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('DificuldadeList', 'onDelete'));
    ...
    public function onDelete($param = null)
    {
        if (isset($param['delete']) && $param['delete'] == 1) {
            try {
                ...
                // instantiates object
                $object = new Dificuldade($key, FALSE);
    ...
    public function onSearch($param = null)
    {
        ...
        if (isset($data->valor) and ((is_scalar($data->valor) and $data->valor !== '') or (is_array($data->valor) and (!empty($data->valor))))) {
            ...
            $filters[] = new TFilter('valor', 'ilike', "%{$data->valor}%");// create the filter
        }
