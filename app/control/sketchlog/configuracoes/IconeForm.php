...
class IconeForm extends TPage
{
    private $form;
    public static $formName = 'form_IconeForm';
    ...
    public function __construct($param)
    {
        ...
        $this->form->setFormTitle("Cadastro de Icone");
        ...
        $imagem->setAllowedExtensions( ['svg'] );
    ...
    public function onSave($param)
    {
        try {
            ...
            AdiantiCoreApplication::loadPage('IconeList', 'onReload');
        }catch (Exception $e){
    ...
    public function onEdit($param)
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new Icone($key); // instantiates the Active Recor
