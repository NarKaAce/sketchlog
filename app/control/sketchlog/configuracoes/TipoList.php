...
class TipoList extends TPage
{
    ...
    private static $formName = 'form_TipoList';
    private $limit = 20;
    ...
    public function __construct($param = null)
    {
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['TipoForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onDelete = new TDataGridAction(array('TipoList', 'onDelete'));
