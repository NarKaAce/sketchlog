...
class GeneroList extends TPage
{
    ...
    private static $formName = 'form_GeneroList';
    private $limit = 20;
    ...
    public function __construct($param = null)
    {
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['GeneroForm', 'onShow']), 'fas:plus #69aa46');
